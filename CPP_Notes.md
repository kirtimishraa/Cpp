...
### C (created in 1972) 
    Was fast, powerful, and great for low-level systems programming
...
### Namespace: 
    ...
    - Using "namespace": TO specify which inbuilt function we're using 
        ...
        Instead of wrting std:: eveytime we can:
            ...
            using namespace std;        # Means we're using functions from standard library But this may create collisions
            cin>>variable_name;
